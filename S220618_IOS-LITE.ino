...
Added new opcode 0x10 to send SPI commands
Basic test code 
led on:
10 out 1,16
20 out 0,1
...
// ------------------------------------------------------------------------------
  ...
  // Initialize SPI
  // Work around to solve ESP32 module boot problem
  pinMode(SS_, OUTPUT);
  pinMode(MISO, OUTPUT);
  ...
  // I/O operaton requested
  {
    ...
    
    {
      ...
      //
      {
        ...
        case 0x10:
          // spi command for the esp32 module
          digitalWrite(SS_, LOW);
          SPI.transfer(0x10);    // opcode to esp32
          SPI.transfer(ioData);  // data
          digitalWrite(SS_, HIGH);
        break;
        }
